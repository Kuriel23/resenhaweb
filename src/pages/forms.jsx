      ...
      <Container>
        <Section>
          ...
          <Center>
            ...
            >
              <GridItem mb="10px">
                <Link href="/forms/mod" isExternal>
                  <Box
                    borderBottomRadius={50}
                    borderColor="yellow"
                    borderWidth="1px"
                  >
                    <Image src="https://i.imgur.com/7cNX9zO.jpeg" />
                  ...
                  >
                    ...
                    <Box p={3} borderBottomRadius={50} bg="#2C2F33">
                      ...
                      <Text color="gray.300" fontSize="lg">
                        ...
                        chamar atenção nos chats, principalmente em horas de
                        pico, estamos sempre á procura de pessoas que queiram
                        exercer essa função!
                      </Text>
                    </Box>
                  </Box>
                ...
                <Link href="/forms/sp" isExternal>
                  ...
                  >
                    ...
                    <Box p={3} borderBottomRadius={50} bg="#2C2F33">
                      ...
                      <Text color="gray.300" fontSize="lg">
                        Então, você quer se responsabilizar pelas parcerias do
                        nosso servidor, é? Este é um cargo que poderá exigir um
                        pouco de esforço e tempo, mas sempre acaba valendo a
                        pena, acredito em você, soldado!
                      </Text>
                    </Box>
                  </Box>
                </Link>
